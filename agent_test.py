...
def save_to_supabase(location, content):
    """정리된 컬럼(title, location, content, category, curator_id)에 맞춰 저장"""
    ...
    try:
        ...
        data = {
            ...
            "location": location,
            "content": str(content),  # 에이전트가 쓴 상세 리스트 전체
...
if __name__ == "__main__":
    ...
    for loc in locations:
        ...
        task = Task(
            description=f"""
                ...
                1. 데이트: 조명과 분위기가 좋아 데이트하기 좋은 와인바/다이닝
    ...
    print("\n✨ DB 정리 후 첫 수집 완료! 이제 Supabase가 깔끔해졌을 거예요.")